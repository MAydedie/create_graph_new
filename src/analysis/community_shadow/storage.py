...
class CommunityShadowStorage:
    def __init__(self, storage_dir: str = "output_analysis/community_shadow") -> None:
    ...
    def save(self, project_path: str, community_shadow: Dict[str, Any]) -> Path:
        filepath = self._build_filepath(project_path)
        payload = dict(community_shadow)
